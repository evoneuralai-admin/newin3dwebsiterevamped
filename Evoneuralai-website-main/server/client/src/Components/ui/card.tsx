...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "surface-card rounded-[1.75rem] border border-border/70 bg-card/85 text-card-foreground shadow-card backdrop-blur-2xl transition-all duration-200 hover:-translate-y-1 hover:shadow-card-hover",
      className
    )}
    {...props}
  />
